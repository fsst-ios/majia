...
class Expenses extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> entryType = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('\'purchase\''),
  );
...
class SyncRuntimeEntries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncRuntimeEntries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SyncRuntimeEntries createAlias(String alias) {
    return SyncRuntimeEntries(attachedDatabase, alias);
  }
}

class SyncConflictEntries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SyncConflictEntries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SyncConflictEntries createAlias(String alias) {
    return SyncConflictEntries(attachedDatabase, alias);
  }
}
...
class DatabaseAtV6 extends GeneratedDatabase {
  ...
  late final SyncRuntimeEntries syncRuntimeEntries = SyncRuntimeEntries(this);
  late final SyncConflictEntries syncConflictEntries = SyncConflictEntries(
    this,
  );
  @override
